<template>
  <div class="comment_area">
    ...
    <form-alert v-if="alert" data="댓글" confirm="삭제" @onagree=" agree" @ondisagree="disagree"></form-alert>
  </div>
</template>
...
.comment_area{position: relative; margin: 17px 0;}
.trigger{position: absolute;  left:0; bottom:0; width: 100%; height: 20px;}
</style>
